...
HD_PWD='C:/Fpga_projects/full_subtractor/full_subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_subtractor.tcl
