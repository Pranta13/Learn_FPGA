...
REM
REM Generated by Vivado on Sat May 23 13:31:03 +0600 2026
...
echo "xvlog --incr --relax -prj full_subtractor_tb_vlog.prj"
call xvlog  --incr --relax -prj full_subtractor_tb_vlog.prj -log xvlog.log
