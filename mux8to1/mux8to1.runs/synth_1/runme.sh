...
HD_PWD='C:/Fpga_projects/mux8to1/mux8to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux8to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux8to1.tcl
