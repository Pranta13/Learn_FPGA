...
REM
REM Generated by Vivado on Fri May 22 10:48:04 +0600 2026
...
echo "xvlog --incr --relax -prj mux8to1_tb_vlog.prj"
call xvlog  --incr --relax -prj mux8to1_tb_vlog.prj -log xvlog.log
