...
HD_PWD='C:/Fpga_projects/demux1to8/demux1to8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux1to8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux1to8.tcl
