...
REM
REM Generated by Vivado on Fri May 22 11:15:28 +0600 2026
...
echo "xvlog --incr --relax -prj demux1to8_tb_vlog.prj"
call xvlog  --incr --relax -prj demux1to8_tb_vlog.prj -log xvlog.log
