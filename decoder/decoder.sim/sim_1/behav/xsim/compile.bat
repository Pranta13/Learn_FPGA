...
REM
REM Generated by Vivado on Sat May 23 23:34:20 +0600 2026
...
echo "xvlog --incr --relax -prj decoder_2to4_tb_vlog.prj"
call xvlog  --incr --relax -prj decoder_2to4_tb_vlog.prj -log xvlog.log
