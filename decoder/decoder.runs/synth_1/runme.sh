...
HD_PWD='C:/Fpga_projects/decoder/decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2to4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_2to4.tcl
