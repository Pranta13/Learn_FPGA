...
HD_PWD='C:/Fpga_projects/encoder/encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4to2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_4to2.tcl
