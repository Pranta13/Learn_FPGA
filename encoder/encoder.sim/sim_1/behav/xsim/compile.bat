...
REM
REM Generated by Vivado on Sat May 23 23:20:21 +0600 2026
...
echo "xvlog --incr --relax -prj encoder_4to2_tb_vlog.prj"
call xvlog  --incr --relax -prj encoder_4to2_tb_vlog.prj -log xvlog.log
